...
The plugin starts from PKP plagiarism 3.2, add Radek (https://github.com/pkp/plagiarism/pull/31) wonderful support for settings, and add some more functionality, among which:
